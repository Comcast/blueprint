...
import com.xfinity.blueprint.architecture.fragment.ToolbarScreenViewFragment
 ...
 */
class CustomLayoutFragmentActivity: AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.custom_layout_fragment_activity)
    }
}

class CustomLayoutFragment : ToolbarScreenViewFragment<CustomScreenView>() {
    ...
    private val resourceProvider: ResourceProvider by lazy { ResourceProvider(activity) }
    ...
    override fun getFragmentTag(): String = "CustomLayoutFragment"
